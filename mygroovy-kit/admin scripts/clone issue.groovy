/**
 ...
 - Access variables in scripts - httpClient, templateEngine, log, issue, currentUser, componentAccessor, baseUrl, cfValues (key - id as Long/cfName as String), cloneIssue (Additional issue actions)
...
return copyIssue(issue, createCopyLinks, prefixSummary, createCopyAttachments, targetProjectKey, targetIssueTypeId as String, copyFields, runAsUser, issueLinkTypeId)
...
def copyIssue(issue, Boolean createCopyLinks, String prefixSummary, Boolean createCopyAttachments, String targetProjectKey, String targetIssueTypeId, String copyFields, ApplicationUser runAsUser, Long issueLinkTypeId) {
    ...
    def projectId = getProjectByKey(targetProjectKey)?.id
    ...
    createLink(issue, newIssue, issueLinkTypeId, 0, runAsUser)
    return newIssue
}
