...
if (sendToUsers) {
    emailsTo = emailsTo + sendToUsers.collect { return it.getEmailAddress() }
}
...
if (sendCopyToUsers) {
    copyTo = copyTo + sendCopyToUsers.collect { return it.getEmailAddress() }
}
...
if (stringEmailsTo) {
    sendEmail(stringEmailsTo, stringCopyTo, subject, body, from, replyTo, emailFormat)
}
...
def sendEmail(String emailAddr, String copy, String subject, String body, String from, String replyTo, String emailFormat) {
